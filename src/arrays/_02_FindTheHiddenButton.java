...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String numbah = JOptionPane.showInputDialog("create a number less than 673.(the lower you go, the easier it is)");
		int buttonsNum = Integer.parseInt(numbah);
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		buttons = new JButton[buttonsNum];
		//5. Make a for loop to iterate through the JButton array
		for(int a = 0; a<buttonsNum;a++) {
		...
		Random r = new Random();
		hiddenButton = r.nextInt(buttonsNum);
		hiddenButton += 1;
